```js noeditor
const P = require('./Typography.js').P;
const Title = require('./Typography.js').Title;
const SubTitle = require('./Typography.js').SubTitle;

<div>

  <h2>H2 tag in text</h2>
  <h3>H3 tag in text</h3>
  <h4>H4 tag in text</h4>
  <h5>H5 tag in text</h5>
